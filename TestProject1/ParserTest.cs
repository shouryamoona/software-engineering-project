...
namespace TestProject1
{
    ...
    public class ParserTest
    {
        ...
        /// <summary>
        ///A test for hasTimePassed
        ///</summary>
        [TestMethod()]
        [DeploymentItem("Alfred.exe")]
        public void hasTimePassedTest()
        {
            string endTime = string.Empty; // TODO: Initialize to an appropriate value
            string endTimeExpected = string.Empty; // TODO: Initialize to an appropriate value
            Parser_Accessor.hasTimePassed(ref endTime);
